...
function ForgotPassword() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!rollNumber || !email) {
      setError(
        "Please enter your University Roll Number and ABES Email ID."
      );
      return;
    }
    ...
    if (!/^[^\s@]+@abes\.ac\.in$/i.test(email)) {
      setError(
        "Please enter a valid ABES email ID."
      );
      return;
    }
    ...
    setSuccess(
      "OTP has been sent to your registered ABES email."
    );
    ...
    <div className="forgot-page">
      ...
      <div className="forgot-container">
        ...
        <div className="forgot-header">
          ...
          <p>
            Don't worry! Enter your registered details
        ...
        <div className="forgot-note">
          ...
          For security reasons, OTP will only be sent
          to the email address registered with your account.
